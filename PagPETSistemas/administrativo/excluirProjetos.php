...
<div>
    ...
    <div>
        <form name="input" action="atualizarProjeto.php" method="post">
            ...
            <div id="dadosProjeto">
            	<b>Nome do Projeto:</b>
            	<input size="60px" type="text" name="nomeProjeto" disabled="true"/>
            	<br />

            	<b>Data de Inicio: </b>
            	<input id="datef" maxlength="10" size="8px" type="text" name="dataInicio" disabled="true"/>
            	<br />

            	<b>Data de Fim: </b>
            	<input id="date" maxlength="10" size="8px" type="text" name="dataFim" disabled="true"/>
            	<br />
            
            	<b>Descrição:</b>
            	<br />
            	<textarea rows="10" cols="30" name ="desc" style="width:300px;height:100px" disabled="true"></textarea>
            	<br />
            	...
            	<b>Tutor:  </b>
            	<select  name="tutor" disabled="true">
            	...
            	<select multiple="multiple" name="usuario_id_usuario" style="width:300px;height:200px" disabled="true">
            	<?php while ($dados = mysql_fetch_array($query)) { ?>
