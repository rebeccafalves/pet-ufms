...
include ("/incluirArquivo.php"); //arquivo de coneccao com o banco
...
header("Location: ../index.php?cod=cadastrarUsuarios&in=$in"); //encaminha para a tela de cadastro, passando o codigo de retorno
?>
